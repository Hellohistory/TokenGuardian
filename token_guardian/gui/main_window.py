...
from token_guardian.core.storage import (
    SecureTOTPManager,
    export_specific_secrets,
)
from token_guardian.core.otp import TOTP, HOTP
...
class SecureTOTPManagerGUI(QMainWindow):
    ...
    def __init__(self, password):
        super().__init__()
        self.setWindowTitle("TokenGuardian - 令牌守护者")
        self.setWindowIcon(QIcon("assets/icons/icon.png"))
    ...
    def init_menu(self):
        ...
        exp_all = file_menu.addAction(
            QIcon("assets/icons/export.png"), "导出所有密钥"
        )
        imp = file_menu.addAction(
            QIcon("assets/icons/import.png"), "导入密钥"
        )
        file_menu.addSeparator()
        exit_act = file_menu.addAction(
            QIcon("assets/icons/exit.png"), "退出"
        )
        ...
        add_key = key_menu.addAction(
            QIcon("assets/icons/add.png"), "添加密钥"
        )
        ...
        help_menu.addAction(
            QIcon("assets/icons/about.png"), "关于", self.show_about_dialog
        )
    ...
    def refresh_table(self):
        ...
        for name, secret, algo, counter in self.core.get_secrets():
            ...
            del_btn.setIcon(QIcon("assets/icons/remove.png"))
            ...
            exp_btn.setIcon(QIcon("assets/icons/export_part.png"))
    ...
    def show_about_dialog(self):
        ...
        msg.setWindowTitle("关于 TokenGuardian")
        msg.setIconPixmap(
            QPixmap("assets/icons/icon.png").scaled(64, 64)
        )
